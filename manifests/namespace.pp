...
define openiosds::namespace (
  ...
  $sqliterepo_hard_max = undef,
  $sqliterepo_soft_max = undef,
  ...
  if $sqliterepo_hard_max { validate_integer($sqliterepo_hard_max) }
  if $sqliterepo_soft_max { validate_integer($sqliterepo_soft_max) }
